...
class Table:
    ...
    def create(self, values:dict): # there won`t ever be all fields to insert as some fields will be generated by dB       
        ...
        try:
            ...
            connection.commit()
            return "Data inserted successfully in the table."
        except Exception as e:
            return f"Error: {e}"
